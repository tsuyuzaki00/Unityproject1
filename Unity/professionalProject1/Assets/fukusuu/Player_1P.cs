...
public class Player_1P : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool Y = Input.GetKeyDown("joystick 1 button 3");
        bool B = Input.GetKeyDown("joystick 1 button 1");
        bool X = Input.GetKeyDown("joystick 1 button 2");
        bool A = Input.GetKeyDown("joystick 1 button 0");
        bool R = Input.GetKeyDown("joystick 1 button 5");
        bool L = Input.GetKeyDown("joystick 1 button 6");
