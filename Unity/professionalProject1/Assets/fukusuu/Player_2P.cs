...
public class Player_2P : MonoBehaviour {
    ...
    void Update()
    {
        float h = Input.GetAxis("2P_Horizontal");
        float v = Input.GetAxis("2P_Vertical");
        bool Y = Input.GetKeyDown("joystick 2 button 3");
        bool B = Input.GetKeyDown("joystick 2 button 1");
        bool X = Input.GetKeyDown("joystick 2 button 2");
        bool A = Input.GetKeyDown("joystick 2 button 0");
        bool R = Input.GetKeyDown("joystick 2 button 5");
        bool L = Input.GetKeyDown("joystick 2 button 6");
